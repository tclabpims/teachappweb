...
<div class="nr">
    ...
    <div class="pagemain">
        ...
        <div>
            <br/>
            <form class="layui-form" action="${pageContext.request.contextPath}/rateStat/extremeStat.do" METHOD="post">
                &nbsp;&nbsp;&nbsp;
        ...
        <h3 align="center">${schoolyear}<c:if test="${semester != null and semester != ''}">-${semester}</c:if>学期（或者学年）各系听课评价最值统计</h3>
        <%--<hr/>--%>
        <table class="sui-table table-bordered" style="margin-top:20px;">
            <thead>
            <tr>
                <th class="center left-con" width="8%">编号</th>
                <th class="center left-con" width="20%">系别</th>
                <th class="center left-con" width="18%">最高分</th>
                <th class="center left-con" width="18%">最低分</th>
                <th class="center left-con" width="18%">平均分</th>
                <th class="center left-con" width="18">中位数</th>
            </tr>
            </thead>
            <tbody id="all_task0">
            ...
            <c:forEach items="${list}" var="item">
                <tr>
                    ...
                    <td class="center left-con">${item.maxValue}</td>
                    <td class="center left-con">${item.minValue}</td>
                    <td class="center left-con">${item.avgValue}</td>
                    <td class="center left-con">${item.middleValue}</td>
                </tr>
            </c:forEach>
            </tbody>
    </table>
...
<%--分页 end--%>
<script type="text/javascript" src="${pageContext.request.contextPath}/statics/js/rateStat/extremeStat.js"></script>
</body>
</html>
